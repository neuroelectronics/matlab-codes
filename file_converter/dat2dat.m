function [f_out]=dat2dat(f_in,extention,s_time, end_time,Rs,CH_N)
...
fseek(fid,0,'eof');
f_duration_sec=end_time; %ftell(fid)./(2*CH_N*Rs);
fclose(fid);
...
for stream=s_time*Rs:duration:f_duration_sec*Rs
